...
if ($success) {
    ...
    if ($gatewayParams['billplz_success_path'] == 'viewinvoice') {
        $redirect_url = $CONFIG['SystemURL'] . '/viewinvoice.php?id=' . $invoiceId;
    } elseif ($gatewayParams['billplz_success_path'] == 'listinvoice') {
    ...
    if ($gatewayParams['billplz_failed_path'] == 'viewinvoice') {
        $redirect_url = $CONFIG['SystemURL'] . '/viewinvoice.php?id=' . $invoiceId;
    } elseif ($gatewayParams['billplz_failed_path'] == 'listinvoice') {
        $redirect_url = $CONFIG['SystemURL'] . "/clientarea.php?action=invoices";
    } else {
        $redirect_url = $CONFIG['SystemURL'] . "/clientarea.php";
    }
